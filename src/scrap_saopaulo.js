...
async function scrap(pag){   
    ...
    const options = {
        method: 'GET',
        url: 'https://www.drogariasaopaulo.com.br/buscapagina',
        qs: {
          '': '',
          fq: ['C:/800/', 'specificationFilter_180:Anti-inflamatórios'],
          PS: '48',
          sl: '727d3c85-e93a-42fd-bd7e-42dfd3978c22',
          cc: '48',
          sm: '0',
          PageNumber: '2'
        },
    ...
    request(options, function (error, response, body) {
        ...
        const farmacia = 'DROGARIASSAOPAULO'
        let horaScrap = time()
